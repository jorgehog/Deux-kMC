...
inline double getMFPTConstant(const double h0, const double alpha, const int type)
{
    ...
    const maptype valueMapRadial = {{{0,  3}, 0.067},
                                    {{0,  4}, 0.061},
                                    {{0,  5}, 0.069},
                                    {{0,  6}, 0.067},
                                    {{0,  7}, 0.070},
    ...
    const maptype valueMapPathfinding = {{{0,  3}, 0.068},
                                         {{0,  5}, 0.062},
                                         {{0,  6}, 0.078},
                                         {{0,  7}, 0.084},
                                         {{0,  8}, 0.086},
    ...
    const vec knownHeights = {5.0, 10.0, 15.0, 20.0};
    const vec knownAlphas  = {0.5       , 0.66666667, 0.83333333, 1.        , 1.16666667,
